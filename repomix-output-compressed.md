...
tr[cdkdrag] {
⋮----
/* 🔥 Make drag preview behave like a table */
⋮----
/* Make preview cells keep spacing */
.cdk-drag-preview td {
⋮----
/* Prevent weird stretching animation */
⋮----
...
<div class="bg-white rounded-xl p-4 sm:p-5 shadow-sm relative">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-5">
        ...
        <!-- Icon (top-right on small, normal on sm+) -->
...
⋮----
/* single-select value — clean text, no chip */
...
⋮----
/*** Ng Select — .filter-select Variant ***/
⋮----
.filter-select ::ng-deep .ng-select-container,
⋮----
.filter-select ::ng-deep .ng-select-container .ng-clear-wrapper,
...
<div class="border border-gray-200 rounded-xl shadow-sm overflow-hidden bg-white">
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-xs sm:text-sm text-left border-collapse table-auto">
            <!-- ^^^ REMOVED table-fixed, REMOVED min-w-160/180 (let columns dictate) -->
...
/* ═══════════════════════════════════════════════════════════════════════════
   ASSIGNEES CONTAINER
   Main wrapper - fixed width, flex layout with button outside scroll
   ═══════════════════════════════════════════════════════════════════════════ */
.assignees-container {
⋮----
/* FIXED WIDTH - no shrink, no grow */
⋮----
/* Card styling */
⋮----
/* Responsive width for sm breakpoint */
⋮----
/* ═══════════════════════════════════════════════════════════════════════════
   CONTENT AREA
   Wrapper that contains scrollable area + fade overlay
   ═══════════════════════════════════════════════════════════════════════════ */
.content-area {
⋮----
/* ═══════════════════════════════════════════════════════════════════════════
...
⋮----
/* Expanded mode: enable scroll with HIDDEN scrollbar */
...
/* ═══════════════════════════════════════════════════════════════════════════
   CHIPS ROW
   Flex container for user chips - width: max-content for natural sizing
   ═══════════════════════════════════════════════════════════════════════════ */
.chips-row {
⋮----
/* ═══════════════════════════════════════════════════════════════════════════
   ASSIGNEE CHIP
   Individual user pill - NEVER truncate, NEVER ellipsis
   ═══════════════════════════════════════════════════════════════════════════ */
.assignee-chip {
⋮----
.avatar {
...
.name {
⋮----
/* NO text-overflow: ellipsis - NEVER truncate */
⋮----
/* ═══════════════════════════════════════════════════════════════════════════
   MORE BUTTON
   "+N more" chip - ALWAYS outside scroll area, sticky to right
   ═══════════════════════════════════════════════════════════════════════════ */
.more-chip {
⋮----
...
/* ═══════════════════════════════════════════════════════════════════════════
   FADE OVERLAY
   Right-side gradient in expanded mode - indicates more content
   ═══════════════════════════════════════════════════════════════════════════ */
.fade-overlay {
⋮----
/* ═══════════════════════════════════════════════════════════════════════════
   EMPTY STATE
   "No users assigned" display
   ═══════════════════════════════════════════════════════════════════════════ */
.empty-state {
⋮----
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════════════════ */
⋮----
/* Expanded mode - subtle highlight */
...
⋮----
/* ✅ FIX: Add padding at the end so the last user isn't covered by the fade */
/* Width should be slightly larger than your fade-overlay width (approx 30-40px) */
⋮----
/* Ensure the scrollbar remains hidden (keep your existing scrollbar hiding code) */
⋮----
/* Firefox */
⋮----
/* IE/Edge */
...
<nav class="sticky top-0 z-9999 bg-white backdrop-blur-xl shadow-[0_10px_30px_rgba(168,85,247,0.25)] px-6 py-4">
    <div class="w-full flex items-center justify-between">
        ...
        <!-- ===== LOGGED-IN: MOBILE SLIDE MENU (<md) ===== -->
        ...
        <!-- ===== LOGGED-OUT (not on login/signup): LOGIN BUTTON — responsive ===== -->
        ...
        <!-- Logged out AND on /login or /signup → nothing extra renders (just logo) -->
...
<td class="px-1.5 sm:px-4 py-2 sm:py-3 text-center w-45">
    <div #assigneesContainer class="assignees-container" [class.expanded]="expandedSig()"
        ...
        <div class="content-area">
            ...
            <!-- Fade overlay - only in expanded mode with overflow -->
            @if (expandedSig() && hasOverflowSig()) {
            <div class="fade-overlay"></div>
            }
        </div>

        <!-- +N More button - ALWAYS outside scroll area, sticky right -->
        @if (hiddenCountSig() > 0) {
...
<div class="min-h-screen p-4 md:p-6 lg:p-8 transition-colors duration-500" [ngClass]="isDark
    ...
    <!-- ══════════════════════════════════════════════════════════
     FLOATING THEME TOGGLER — RIGHT EDGE
     ══════════════════════════════════════════════════════════ -->
    ...
    <div class="fixed right-0 top-1/2 -translate-y-1/2 z-[999] flex items-center">
      ...
      : 'translate-x-full opacity-0 scale-95 pointer-events-none'">
        ...
        <!-- ── Floating Tab Trigger (always visible on edge) ── -->
